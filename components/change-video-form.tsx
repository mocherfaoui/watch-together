...
export default function ChangeVideoForm({
  ...
  return (
    <div className='w-full max-w-md mx-auto'>
      <div className='hidden md:block text-left mb-6 md:text-center md:mb-12'>
        <h2 className='font-semibold text-foreground md:text-5xl md:font-bold md:leading-[1.1] md:text-transparent md:bg-clip-text md:bg-linear-to-r md:from-white md:to-white/60'>
          {CHANGE_VIDEO_TITLE}
        </h2>
      </div>
      <UpdateRoomForm
